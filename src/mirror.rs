pub const MIRROR: [(bool,&'static str); 9] = [
  ...
  (false,"raw.githubusercontent.com/i18n-site/bin.dist/main/"),
  (false,"atomgit.com/i18n-site/bin.dist/raw/main/"),
  (true,"xxai.eu.org/i18n.site/bin/"),
  (false,"github.com/i18n-site/bin/releases/download/")
];